...
// test #2 begin
	TEST_ALU (7 ,9 , 0, 0, 2); // (A,B,AINV,BNEG,Opr)  ADD
// test #2 end

// test #3 begin
	TEST_ALU ( 7, 7, 0, 0, 2); // (A,B,AINV,BNEG,Opr)  ADD
// test #3 end

// test #4 begin
	TEST_ALU ( 8, 15 , 0, 0, 2); // (A,B,AINV,BNEG,Opr)  ADD
// test #4 end
...
// test #6 begin
	TEST_ALU ( 2, 3 , 0, 1, 2); // (A,B,AINV,BNEG,Opr)  SUB
// test #6 end

// test #7 begin
	TEST_ALU ( 8, 7 , 0, 1, 2); // (A,B,AINV,BNEG,Opr)  SUB
// test #7 end

// test #8 begin
	TEST_ALU (7 , 8 , 0, 1, 2); // (A,B,AINV,BNEG,Opr)  SUB
// test #8 end
